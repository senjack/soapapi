...
from .models import InterviewCategory, StructureIndicator, CategoryStructure, InterviewSet

refactory_models_list = [InterviewCategory,
                         RefactoryUser, Administrator, Staff, Applicant, Cohort, Catalyst, Bootcamp, Contact, EducationBackground, SkillSet, Honor, ApplicationVideo, Interview, Role, AdministratorRole, StructureIndicator, CategoryStructure, InterviewSet]
